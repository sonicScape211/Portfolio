...
namespace FinalApplication.Controllers
{
    ...
    {
        private AuctionModelContext db = new AuctionModelContext();
        ...
        public ActionResult Create([Bind(Include = "BidID,ItemID,BuyerID,Price,BidTime")] Bid bid)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BidID,ItemID,BuyerID,Price,BidTime")] Bid bid)
        {
            if (ModelState.IsValid)
            {
