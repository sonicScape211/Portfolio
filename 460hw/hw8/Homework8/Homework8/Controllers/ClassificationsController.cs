...
namespace Homework8.Controllers
{
    public class ClassificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Genre")] Classification classification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Genre")] Classification classification)
        {
            if (ModelState.IsValid)
            {
